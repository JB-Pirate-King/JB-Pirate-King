...
//  12  anchor_motion           anchor_motion
//  13  kinematic_speed_gap     kinematic_speed_gap
//  14  heading_micro_jitter    heading_micro_jitter
//  15  status_expected_speed_dev  status_expected_speed_dev
